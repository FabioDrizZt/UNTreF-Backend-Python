...
s.isalnum()            # Verifica si los caracteres son alfanuméricos
...
s.lstrip()              # Elimina espacios en blanco al inicio (izquierda)
s.rstrip()              # Elimina espacios en blanco al final (derecha)
